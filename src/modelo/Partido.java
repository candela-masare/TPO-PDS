...
public class Partido {
    ...
    public Partido(Equipo equipoLocal, Equipo equipoVisitante, String resultado) {
        this(equipoLocal, equipoVisitante, resultado, 0, null);
    }

    public Partido(Equipo equipoLocal, Equipo equipoVisitante, String resultado, int idArbitro) {
        this(equipoLocal, equipoVisitante, resultado, idArbitro, null);
    }

    public Partido(Equipo equipoLocal, Equipo equipoVisitante, String resultado, Arbitro arbitro) {
        this(equipoLocal, equipoVisitante, resultado, 0, arbitro);
    }

    public Partido(Equipo equipoLocal, Equipo equipoVisitante, String resultado, int idArbitro, Arbitro arbitro) {
